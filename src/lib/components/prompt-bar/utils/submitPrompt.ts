...
export async function submitPrompt(
    ...
    fileArray: any[],
    reasoning: boolean,
    errorPopupHandler: (message: string, subText: string | null, duration: number, type: string) => void,
...
async function makeApiRequest(
    ...
    const validConversationId = get(conversationId) && isValidUUID(get(conversationId)!) 
        ? get(conversationId) 
        : undefined;
 ...
 */
async function handleImageGenerationResponse(response: Response, currentChatIndex: number): Promise<void> {
