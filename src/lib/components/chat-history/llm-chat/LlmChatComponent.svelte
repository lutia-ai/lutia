<script lang="ts">
	...
	import { isLlmChatComponent, isModelAnthropic, isModelDeepSeek, isModelGoogle, isModelOpenAI, isModelXAI } from "$lib/types/typeGuards";
	...
	import { processLinks, sanitizeLLmContent } from "$lib/components/chat-history/utils/chatHistory";
