<script lang="ts">
    ...
    const companyColors = {
        openAI: ['rgba(17,169,131,1)','rgba(10,149,111,0.8)','rgba(17,169,131,0.6)','rgba(17,169,131,0.4)','rgba(17,169,131,0.2)'],
        anthropic: ['rgba(254,215,174,1)','rgba(204,155,122,1)','rgba(204,155,122,0.6)','rgba(204,155,122,0.4)','rgba(204,155,122,0.2)'],
    ...
    function processData(inputArray: PartialApiRequest[]): Record<string, UsageObject[]> {
        ...
        const groupedByProvider = inputArray.reduce((acc, curr) => {
