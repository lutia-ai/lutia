...
const mockChatHistoryUpdate = vi.hoisted(() => vi.fn((fn) => {
...
const mockCalculateImageCostByProvider = vi.hoisted(() => vi.fn(() => ({ 
    tokens: 1000, 
    cost: 0.01 
})));
...
describe('submitPrompt', () => {
    ...
    it('should handle user messages with image attachments', async () => {
        ...
        const imageArray = [
            { url: 'data:image/jpeg;base64,abc123', width: 800, height: 600 }
        ];
